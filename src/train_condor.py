...
from src.models.condor.model import CondorGPT
...
def main():
    ...
    parser.add_argument("--config", type=str, required=True, help="Path to condor config yaml")
    args = parser.parse_args()
    
    cfg = load_config(args.config)
    model_type = getattr(cfg.model, "type", "condor")
    if model_type != "condor":
        raise ValueError(
            "train_condor expects model.type='condor'. "
